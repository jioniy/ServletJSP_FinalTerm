...
public class MemberMgr {
	...
	public boolean insertMember(MemberBean bean) {
		...
		try {
			con = pool.getConnection();
			sql = "insert tblMember(id,pwd,name,birthday,university,zipcode"
			...
			pstmt.setString(5, bean.getUniversity());
	...
	public boolean updateMember(MemberBean bean) {
		...
		try {
			con = pool.getConnection();
			String sql = "update tblMember set pwd=?, name=?, birthday=?,"
					+ "university=?, zipcode=?, address=?, hobby=?, job=? where id = ?";
			pstmt = con.prepareStatement(sql);
